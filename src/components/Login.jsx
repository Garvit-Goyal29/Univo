            ...
            <div className='bg-white h-[80vh] w-[68vw] rounded-[2vh] flex items-center justify-center p-2 shadow-2xl border border-[#E0E0E0] shadow-[#E0E0E0]'>
                <div className='h-full w-[50%] p-10 flex flex-col items-start justify-evenly'>
                    ...
                    <div>
                        ...
                        <p className='text-[#6E6D7E] text-[1.5vh] font-semibold'>Hey, welcome back to your special place</p>
                    </div>
                    <form action="" className='flex flex-col justify-evenly h-[40%] items-start'>
                        <input
                            className='w-60 border border-[#6E6D7E] h-8 p-3 text-sm outline-none focus:outline-none focus:ring-0 rounded'
                            id="email"
                            type="email"
