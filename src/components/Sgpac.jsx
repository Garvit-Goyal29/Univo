            ...
            <div className="w-full flex flex-col justify-center items-center min-h-screen">
                <div className="flex flex-col shadow-2xl shadow-gray-500 justify-space items-center overflow-hidden bg-center bg-cover bg-no-repeat"
                    ...
                    <div className="bg-white shadow-2xl shadow-gray-500 p-1 flex flex-col rounded" style={{ width: "35vw", height: "75vh"}}>
                        <div className="text-white flex justify-center items-center border rounded bg-blue-500">
                            <label className="m-1">Course{1} -</label>
                            <label className="m-1">Credit :</label>
                            <input className="w-12 border rounded-lg p-1 m-1 outline-none focus:outline-none focus:ring-0 text-black"
                                type="number" />
                            <label className="m-1">Grade :</label>
                            <select className="w-16 border rounded-lg p-1 m-1 outline-none focus:outline-none focus:ring-0 text-black" name="" id="">
                            ...
                            <button className="bg-red-500 rounded-lg p-1 m-1"
                            >DEL</button>
                        </div>
                        <div className="flex justify-evenly items-center">
                            <button className="w-40 border-2 rounded-lg m-1 bg-blue-600 text-white"
                            >ADD MORE</button>
